...
export class CheckExpiredDebtRepositorySpy implements CheckExpiredDebtRepository {
    id: string
    result = false

    async isExpired(id: string): Promise<CheckExpiredDebtRepository.Result> {
        this.id = id
        return this.result
    }
}
